...
export default function Home({ date, id, setId }) {
  ...
  var mydata = {
    ...
    datasets: [
      {
        label: "Hotel Rating",
        data: ["5", "4.1", "3.9", "4.3", "4.0", "4.1", "4.5"],
      ...
      {
        label: "Food Rating",
        data: ["3.0", "3.7", "4.0", "3.9", "4.4", "4.2", "4.5"],
  ...
  var kolkata = {
    ...
    datasets: [
      {
        label: "Hotel Rating",
        data: ["3", "2.9", "3.2", "3.5", "2.7", "4.3", "3.8"],
